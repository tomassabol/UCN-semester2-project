...
public class ManageEmployees extends JDialog {
	...
	private CRUDEmployees CRUDPanel;
	 ...
	 * @throws SQLException
	 */
	public ManageEmployees(AuthenticationController auth) throws SQLException, NotFoundException {
		this.auth = auth;
		...
		CRUDPanel = new CRUDEmployees(auth);
