...
public class ManageCustomer extends JDialog {
	...
	private static final long serialVersionUID = 2968937622159813532L;
...
//xd
	 ...
	 * @throws SQLException
	 */
	public ManageCustomer(AuthenticationController auth) throws SQLException, NotFoundException {
		this.auth = auth;
		...
		CRUDPanel = new CRUDCustomer(auth);
