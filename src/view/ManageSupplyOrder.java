...
public class ManageSupplyOrder extends JDialog {
	 ...
	 * @throws SQLException
	 */
	public ManageSupplyOrder(AuthenticationController auth) throws SQLException, NotFoundException {
		this.auth = auth;
		this.setTitle("Manage SupplyOrder");
		setModal(true);
		...
		CRUDPanel = new CRUDSupplyOrder(auth);
