...
public class ManageCities extends JDialog {
	 ...
	 * @throws SQLException
	 */
	public ManageCities(AuthenticationController auth) throws SQLException, NotFoundException {
		this.auth = auth;
		this.setTitle("Manage Cities");
		setModal(true);
