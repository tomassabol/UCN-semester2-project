...
public class ManageSupplier extends JDialog{
	 ...
	 * @throws SQLException
	 */
	public ManageSupplier(AuthenticationController auth) throws SQLException, NotFoundException {
		this.auth = auth;
		...
		CRUDPanel = new CRUDSuppliers(auth);
